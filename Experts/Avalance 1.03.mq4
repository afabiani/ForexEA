...
extern string Algo_Name="Avalance";          // AlFa Forex
...
int           Display_Colors                = 10;                         // Display Colors
...
//-- Initial entry logic ---------------------------------------------------------------------------------------------------------------
   ...
   //---------------------------------------------- 
         if(
            ((Pending_Total==0) || ((Pending_Buys < 1) && (BuysThisBar < 1))) && (Open_Total < MaxPositions)
          )
           {
   ...
   //-------------------------------------------------    
        if(
         ((Pending_Total==0) || ((Pending_Sells < 1)&&(SellsThisBar < 1))) && (Open_Total < MaxPositions)
         )
          {
           if( (Spread <= MaxCurSpread) 
            && (SpreadAvg <= MaxAvgSpread) 
...
//--- successful execution
   ...
   ObjectSetText("lblCopyright","Copyright © 2016 AlFa Forex",8,"Arial Bold",SlateGray);
